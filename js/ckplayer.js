...
function ckstyle() {
    var ck = {
        ...
        language: '', 
        flashvars: '{h->3}{wh->}',
        setup: '1,1,1,'+ckdata['adpreload']+',1,1,'+ckdata['adpreorder']+',1,'+ckdata['admarstatus']+',0,0,1,200,0,1,'+ckdata['adpaucls']+',0,1,1,1,2,10,3,0,'+ckdata['simplebar']+','+ckdata['cthidden']+','+ckdata['cthidtime']+',1,0,1,0,1,1,1,1,1,1,250,'+ckdata['logotime']+','+ckdata['advolume']+'',
        pm_bg: '0x000000,100,230,180',
        mylogo: ckdata['showlogo'],
        pm_mylogo: '1,1,-100,-55',
        logo: ckdata['showmark'],
        pm_logo: '0,0,10,20',
        control_rel: newcontrol_rel,
        ...
        pm_advjp: ''+ckdata['adprejp']+',0,2,2,-100,-40',
        pm_padvc: '2,0,-10,-10',
        pm_advms: '2,0,-46,35',
